  ...
  describe('属性 1: 环境阈值检测', () => {
    ...
    test('Property: 环境阈值检测 - 危急状态检测', () => {
      fc.assert(
        fc.property(
          fc.record({
            soilHumidity: fc.float({ min: 0, max: 29.9 }), // 缺水
            airHumidity: fc.float({ min: 0, max: 100 }),
            temperature: fc.float({ min: -40, max: 80 }),
            lightIntensity: fc.float({ min: 0, max: 499.9 }), // 缺光
            timestamp: fc.integer({ min: 1000000000000, max: 9999999999999 }),
          }),
          (sensorData: SensorData) => {
            const result = mockSensorManager.evaluateState(sensorData);
      ...
      fc.assert(
        fc.property(
          fc.oneof(
            // 土壤湿度超出范围
            fc.record({
              soilHumidity: fc.oneof(fc.float({ min: -1000, max: -0.1 }), fc.float({ min: 100.1, max: 1000 })),
              airHumidity: fc.float({ min: 0, max: 100 }),
              temperature: fc.float({ min: -40, max: 80 }),
              lightIntensity: fc.float({ min: 0, max: 50000 }),
              timestamp: fc.integer({ min: 1000000000000, max: 9999999999999 }),
            ...
            fc.record({
              soilHumidity: fc.float({ min: 0, max: 100 }),
              airHumidity: fc.oneof(fc.float({ min: -1000, max: -0.1 }), fc.float({ min: 100.1, max: 1000 })),
              temperature: fc.float({ min: -40, max: 80 }),
              lightIntensity: fc.float({ min: 0, max: 50000 }),
              timestamp: fc.integer({ min: 1000000000000, max: 9999999999999 }),
            }),
            ...
            fc.record({
              soilHumidity: fc.float({ min: 0, max: 100 }),
              airHumidity: fc.float({ min: 0, max: 100 }),
              temperature: fc.oneof(fc.float({ min: -1000, max: -40.1 }), fc.float({ min: 80.1, max: 1000 })),
              lightIntensity: fc.float({ min: 0, max: 50000 }),
              timestamp: fc.integer({ min: 1000000000000, max: 9999999999999 }),
            }),
            // 光照强度为负值
